// fp_score_no_max.cpp — TRUE NEGATIVE
// The inner scoring loop matches step 1 structurally (ptr phi + i32 phi, two
// finds, XOR gate, add accumulator) but there is NO enclosing outer loop.
// Step 2 calls Inner.L->getParentLoop() which returns nullptr → reject.
//
...
//
// Extract target:
//   llvm-extract -func=_Z14score_cut_onlySt6vectorIiSaIiEES_ISt4pairIiiESaIS3_EE
