// fp_diff_containers.cpp — TRUE NEGATIVE
...
//
// Extract target:
//   llvm-extract -func=_Z15compute_bip_cutSt6vectorIiSaIiEES1_S_ISt4pairIiiESaIS3_EE
...
int compute_bip_cut(vector<int> left, vector<int> right,
